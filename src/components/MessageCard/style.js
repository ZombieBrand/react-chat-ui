...
export const Name = styled(Text).attrs({ size: "large" })`
  grid-area: name;
`;

export const Time = styled(Text).attrs({ size: "medium", type: "secondary" })`
  grid-area: time;
  justify-self: end;
`;

export const Status = styled(Text).attrs({ type: "secondary" })`
  grid-area: status;
`;
